...
export function TaxInput({ impostoPercent, onChange }: TaxInputProps) {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <h2 className="text-sm font-semibold text-[#1D3140]">Imposto sobre MC</h2>
      <p className="mt-1 text-xs text-gray-500">
        Percentual aplicado sobre a Margem de Contribuição (não sobre a Receita Bruta).
      </p>
